...
class SpyStubIngredientRepository() : IngredientRepository {
    ...
    override fun findDistinctById(id: Long): List<IngredientRecord> {
    ...
    override fun findAllById(ids: MutableIterable<Long>): MutableList<IngredientRecord> {
        TODO("Not yet implemented")
    }
    ...
    override fun getReferenceById(id: Long): IngredientRecord {
        TODO("Not yet implemented")
    }

    override fun getById(id: Long): IngredientRecord {
        TODO("Not yet implemented")
    }

    override fun getOne(id: Long): IngredientRecord {
        TODO("Not yet implemented")
    }
    ...
    override fun findById(id: Long): Optional<IngredientRecord> {
        TODO("Not yet implemented")
    }
}
